...
<?php
        ...
        $query=
        $result = mysqli_query($con, "SELECT * FROM benhnhan1 ORDER BY `id` ASC");
        mysqli_close($con);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <a class="them"
                                     href="./thembenhnhan.php">Thêm bệnh nhân</a>
                            </h2>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php while($row = mysqli_fetch_array($result)): ?>
                                        <tr>
                                            ...
                                            <td><?= $row['CCCD'] ?></td>
                                            <td><?= $row['soTheBHYT'] ?></td>
                                            <td><?= $row['thoiHaTheBHYT'] ?></td>
                                            <td><?= $row['ngheNghiep'] ?></td>
                                            <td><?= $row['ngayVaoVien'] ?></td>
                                           <td>
                                           <a href="./suabenhnhan.php?id=<?= $row['maBN'] ?> " class="btn btn-danger">Sửa</a>
