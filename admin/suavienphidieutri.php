...
$query = "SELECT maBN,tenKhoa,bhyt from vienphidieutri WHERE maBN = '$id'";
...
<body>
    <div class="main-content">
        ...
        <?php endif; ?>
        <div id="content-box">
            <form id="product-form" method="POST" action="./control/suavienphidieutri.php">
                <div class="wrap-file">
                ...
                <div class="wrap-field">
                    <label>BHYT: </label>
                    <input type="text" name="benhKemTheo" value="<?= $benhnhan['bhyt'] ?>">
     <select name="BHYT" id="BHYT" style="width: 200px;">
       <option value="<?= $benhnhan['bhyt'] ?>"></option>
        ...
        <option value="50">50</option>
            ...
            <div class="quaylai">
                <a href="./dsvienphidieutri.php" class="back-button">quay lại</a>
            </div>
            <div class="clear-both"></div>
        </div>
    </div>
